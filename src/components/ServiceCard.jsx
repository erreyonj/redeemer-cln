...
const ServiceCard = ({title, description}) => {
  ...
  return (
    <div id={title} className="w-[450px] h-[375px] lg:w-[450px] md:w-96 p-3 flex-shrink-0 shadow-md shadow-black bg-[#366067] rounded-md *:text-white snap-center md:last:animate-none md:first:ml-32">
